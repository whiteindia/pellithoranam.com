   ...
   <section class="content-header">
      <h1>
        Package Details
          ...
          <br>
          <div> 
<a href="<?php echo base_url(); ?>Packages/manage_packages"><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add New</b></button></a>
    </div>
                        ...
                        <tr>
                           ...
                           <td class="center">	                                                   		  
                            <!--  <a class="btn btn-sm bg-olive show-subcatgetdetails" href="javascript:void(0);" data-id="<?php echo $sub->id; ?>">
                              ...
                              <a class="btn btn-sm btn-primary" href="<?php echo base_url('Packages/edit_manage_packages/'.$package->id); ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url('Packages/delete_manage_package/'.$package->id); ?>" onClick="return doconfirm()">
