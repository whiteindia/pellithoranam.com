   ...
   <section class="content-header">
      <h1>
        View Staff Details
          ...
          <br><div> 
<a href="<?php echo base_url(); ?>Staff/add_staff"><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add New</b></button></a>
    </div>
      ...
      <div class="row">
         ...
         <div class="col-xs-12">
            ...
            <div class="box">
               ...
               <!-- /.box-header -->
               <?php   $classifieds = $this->uri->segment(3);
               ...
               ?>
                  ...
                  <table id="" class="table table-bordered table-striped datatable">
                    ...
                    // $image=$sub->image;
                        ...
                        <!--     <td class="center"><?php echo $staff->password; ?></td> -->
                           ...
                           <td class="center">                                                             
                            <!--  <a class="btn btn-sm bg-olive show-subcatgetdetails" href="javascript:void(0);" data-id="<?php echo $sub->id; ?>">
                              ...
                              <a class="btn btn-sm btn-primary" href="<?php echo base_url('Staff/edit_staff/'.$staff->id); ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url('Staff/delete_staff/'.$staff->id); ?>" onClick="return doconfirm()">
