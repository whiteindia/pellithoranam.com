			    ...
			    <form role="form" action="" method="post"  class="validate" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group has-feedback">
                     ...
                     <select class="form-control cst-select-1" name="state_id" cst-attr="state" cst-for="" id="state-selector">
                     <option>Select State</option>
                        ...
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">City Name</label>
                            ...
                            data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" name="city_name"  placeholder="City Name" value="<?php echo $data->city_name; ?>">
