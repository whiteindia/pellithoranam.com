   ...
   <section class="content-header">
      <h1>
        View City Details
          ...
          <br><div> 
<a href="<?php echo base_url(); ?>Settings_ctrl/add_city"><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add New</b></button></a>
    </div>

      <ol class="breadcrumb">
         <li><a href="#"><i class=""></i>Home</a></li>
         <li class="active">View City Details</li>
      </ol>
   </section>
   <!-- Main content -->
                     ...
                     <tbody>
                       <?php
						  ...
						  // $image=$sub->image;
                           ?>
                        <tr>
                           <td class="hidden"><?php echo $city->city_id; ?></td>
                           ...
                           <td class="center">	                                                   		  
                            <!--  <a class="btn btn-sm bg-olive show-subcatgetdetails" href="javascript:void(0);" data-id="<?php echo $sub->id; ?>">
                              ...
                              <a class="btn btn-sm btn-primary" href="<?php echo base_url('Settings_ctrl/edit_city/'.$city->city_id); ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url('Settings_ctrl/delete_city/'.$city->city_id); ?>" onClick="return doconfirm()">
