         ...
         <div class="col-md-12">
            ...
            <div class="box box-warning">
               <div class="box-header with-border">
                  <h3 class="box-title">Add caste Details</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
			    <form role="form" action="" method="post"  class="validate" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                     ...
                     <select class="form-control cst-select-1" name="religion_id" cst-attr="country" cst-for="city" id="country-selector">
                     <option>Select religion</option>
                        ...
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">caste Name</label>
                            ...
                            data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" name="caste_name"  placeholder="caste Name">
