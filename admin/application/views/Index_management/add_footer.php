                  ...
                  <input type="file"  name="footer_image" size="20" />
                        ...
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Footer Header</label>
                            ...
                            data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" name="footer_header"></textarea>
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>   
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Footer Para</label>
                            <textarea class="form-control required" data-parsley-trigger="change" 
                            data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" name="footer_para"></textarea>
                           <span class="glyphicon  form-control-feedback"></span>
                        </div> 
