	...
	// https://cdn.datatables.net/buttons/1.5.6/js/buttons.print.min.js
	  var table;
		jQuery(function($){
				...
				(function (){
					dataTableObj = $('#new_users_table').DataTable({ 
					    ...
					    "ajax": {
					        "url": "<?php echo base_url('reports/view_new_user');?>",
					        "type": "POST",
					    ...
					    "columnDefs": [
					    	...
					    	{  "targets": [ 6 ], "orderable": false, "name": "profile-link2", "className": "column-profile-link2", "visible": false },
					    	{  "targets": [ 7 ], "orderable": false, "name": "profile-link", "className": "column-profile-link", "visible": true },
					    	{  "targets": [ 8 ], "orderable": true, "name": "registered", "className": "column-registered", "visible": true },
					    	{  "targets": [ 9 ], "orderable": false, "name": "status", "className": "column-status", "visible": true },
