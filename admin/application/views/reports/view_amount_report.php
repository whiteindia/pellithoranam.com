         ...
         <div class="box">
            ...
            <div class="box-header col-md-12" style="border-right: 1px solid #ededed;border-bottom: 1px solid #3c8dbc;background: #f9f9f9;">
               ...
               <div class="col-md-11" style="width: auto;">
                  ...
                  <input type="text" class="form-control date-input" name="from_date" id="from_date" placeholder="From Date" value="">
               ...
               <div class="col-md-1 search-div" style="margin-top: 12px;">
                  ...
                  <div class="btn-group pull-right">
                     ...
                     <ul class="dropdown-menu" style="margin-left: -90px;">
                       ...
                       <li><a href="<?php echo base_url();?>Reports/view_earning_graph">Earing Graph</a></li>
            ...
            <!-- /.box-header -->
             <div class="box-body" style="margin-top: 74px !important;">
                 ...
                 <table id="amount_table" class="table table-bordered table-striped" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>Sl No</th>
                          <th>Custome Name</th>
