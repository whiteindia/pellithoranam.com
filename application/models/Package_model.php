...
public function upgrade_prem() {
	...
	function upgrade_members($packageid){
		...
		$interest = (int)$this->getCount($mat_id,"interest_from","profile_interest");
		$mails =(int)$this->getCount($mat_id,"mail_from","profile_mails");
		$views =(int)$this->getCount($mat_id,"mobileview_from","mobile_view");
		$sms =(int)$this->getCount($mat_id,"send_sms_from","send_sms");
