...
<!-- FIRST BANNER -->
  ...
  <div class="wed-search-div-main">
    ...
    <h4>Search Results <strong><?php if(!empty($total_candidates)) { echo $total_candidates; } else { echo "0"; } ?> Matches Found</strong></h4><?php } ?>
                     ...
                     <span><img src="<?php echo base_url(); ?>assets/images/save.png"></span> -->
                      <div class="wed-search-btn-bay">
                       <!-- <?php if($this->session->userdata('logged_in')) {
                        ...
                        <?php }
                       ?><b> <a href="<?php echo base_url(); ?>profile/profile_details/<?php echo $candidate->matrimony_id; ?>" class="btn btn-danger" role="button" style="color:ivory;font-size:16px;" target="_blank">View Full Profile</a></b>
                         <?php if($this->session->userdata('logged_in')) {
