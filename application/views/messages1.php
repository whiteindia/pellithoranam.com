...
<div id="replydiv">
        ...
        <!--
			...
			<div id="trash" class="tab-pane fade animated slideInUp">
				...
				if(!empty($trash)) { foreach($trash as $msgsd) { //print_r(end($msgsd->history)->history_datetime);die;
					...
					<div class="tab-content">
						...
						<div class="wed-inbox-top">
							<div class="wed-inbox-top-left">
								...
								<span class="wed-btn-top restore" data-id="<?php echo $msgs->matrimony_id;?>">Restore</span>
							</div>
							<div class="clearfix"></div>
						</div>
						 <div class="wed-search-listing">
									...
									<div class="web-search-detail">
										<div class="wed-msg-top">
											...
											<span class="msg-date">
												...
												//echo $msgsd->history->history_datetime;
												?>
