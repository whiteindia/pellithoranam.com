      ...
      <div class="wed-packages-tab">
        <div class="tab-content">
          ...
          <!-- CLASSIC-PACKAGES -->
            ...
            <a href="https://pellithoranam.com/packagerazorpay/amount=<?= $package->price;?>" ><button   class="wed-btn-class payment" data-id="<?php echo $package->id;?>" > Make Payment</button></a>
