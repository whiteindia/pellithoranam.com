       ...
       <div class="wed-profile-detail-left">
          <div class="wed-profile-pic-div">
            <div class=""> <!-- class= wed-profile-pic-->
              <li><img src="<?php echo base_url(); ?>assets/img/user.jpg" style="!important;" width="200px" height="200px"></li>
            </div>
          </div>
          ...
          <div class="modal-content wed-add-modal-content">
           ...
           <!--    <p>Enter your message</p> -->
            <div class="wed-add-modal-footer">
                ...
                <textarea rows="4" cols="50" name="mail_content">I am <?php echo $sess->profile_name; ?> (T<?php echo $sess->matrimony_id; ?>) from Pellithoranam.com ph: <?php echo $sess->phone; ?> i would like to reach out to you.please share your contact details</textarea><br/>
