	 ...
	 <h1>Personal Information</h1>
             ...
             <!--           <li class="wed-personel-sec-li">
                        ...
                        <li class="wed-personel-sec-li">
                          ...
                          <div class="child2">:</div>
                          <div class="child3"><?php $date = new DateTime($profile[0]->timeofbirth); echo $date->format('h:ia'); ?><small>[24hr format]</small></div>
                          <div class="clearfix"></div>
                        </li>
                        <li class="wed-personel-sec-li">
        ...
        <div class="modal-dialog wed-add-modal-dialogue">
          <div class="modal-content wed-add-modal-content">
            ...
            <div class="wed-add-modal-footer">
                ...
                <textarea class="wed-reg-modal-textarea" cols="50" name="mail_content" readonly>Hi,Please check the profile ( <?php echo $sess->matrimony_id; ?>) from Pellithoranam.com </textarea><br/>
