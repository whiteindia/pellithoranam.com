                          ...
                          <div class="wed-noticationlist">
                            ...
                            <?php if (!empty($history)) {
                              foreach ($history as $hist) {
                                if ($hist->history_type == "INTEREST_SENT") {
                                  $hist_type = "interest";
                                } else if ($hist->history_type == "MESSAGE_SENT") {
                                  $hist_type = "message";
                                } else {
                                  $hist_type = "photo request";
                                }
                                $msg = "<b>" . $hist->profile_name . "</b> has sent you a " . $hist_type;  ?>
                                <div style="border-bottom: 1px solid #ededed;">
                                  <a href="<?php echo base_url(); ?>Profile/inbox">
                                    <p><?php echo  $msg ?></p>
                                  </a>
      ...
      $(document).on("click", "#frgt_psw", function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data == 1) {
              $('#frgt_psw_msg').html('Check your Mobile to get your temporary password');
              //alert('ffdgg');
            } else {
