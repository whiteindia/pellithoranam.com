...
<!-- <a class="btn btn-sm btn-danger custom-btn" href="<?php echo base_url('home/remove_member/'.$_SESSION['user_id']); ?>" onClick="return doconfirm()" title="Delete profile completely"> <i class="fa fa-fw fa fa-power-off"></i></a>--->
</li>
