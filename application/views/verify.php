      ...
      <div class="wed-verify-inner">
        ...
        <div class="wed-verify-code">
          <form id="loginform" method="post">
            <!--- name="myForm" action="<?php echo base_url(); ?>verify/check_otp" onsubmit="return validateForm()"--->
            ...
            <span style="color:red;"><?php if (isset($success)) {
                                        echo 'congratulations your account is verified'; ?><a href="<?php echo base_url(); ?>Verify/send_email_to_other_user"><strong>click here to send alert to other users now</strong></a><?php } ?></span>
          </form>
          ...
          <div id="wait" class="bg-light" style="display:none;width:350px;height:150px;position:absolute;top:30%;left:30%;padding:2px;">
            <div class="container-fluid">
              ...
              <br>Please Wait we are veryfying your otp
            </div>
          </div>
          <a href="<?php echo base_url(); ?>Verify/resend_otp/<?= $my_matr_id->phone; ?>"><strong>Resend Pin to Mobile number</strong></a>
          </p>
          <hr>
