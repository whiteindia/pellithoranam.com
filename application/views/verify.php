        ...
        <div class="container container-custom">
          <div class="wed-verify-inner">
            ...
            <div class="wed-verify-code">
              ...
              <span style="color:red;"><?php if(isset($this->uri->segment(3))&&$this->uri->segment(3)=='success') { echo 'congratulations your account is verified';?><a href="<?php echo base_url(); ?>Verify/send_email_to_other_user"><strong>click here to send alert to other users now</strong></a><?php } ?></span>
            </form>
