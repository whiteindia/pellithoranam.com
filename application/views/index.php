...
<!-- /////////////////////////////////////////////////////////////////// HIGHLIGHTED-PROFILES  END-->
     ...
     <div class="container">
       ...
       <!--  <a href="/package" class="btn-pckg" style="">View Packages</a> -->
         <p> To know more, call us @ <i class="fa fa-mobile bg-success" aria-hidden="true"></i>+91 8187893236 <i class="fa fa-mobile bg-success" aria-hidden="true"></i> +91  7893419636  <i class="fa fa-phone-square bg-success" aria-hidden="true"></i>040-42709366</p>  <!-- 78934 19537 -->
          </div> 
     </div> 
     </div>
